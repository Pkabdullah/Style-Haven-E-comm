"use client";
import MenSliders from "@/components/Sliders/MenSlider";
    ...
    async function getSearch() {
      try {
        const response = await fetch(
          `http://localhost:1337/api/mensections?populate[categories][populate][products][populate][image]=*`,
          {
            method: "GET",
            headers: {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden">
        <div className="text-5xl  font-bold mt-44 flex justify-center">
        ...
        <div className="flex flex-wrap gap-20 p-6 mt-10">
          {record.map((product, index) => (
            ...
            >
              <div className="rounded-lg border border-gray-300  p-6 shadow-2xl">
                <div
