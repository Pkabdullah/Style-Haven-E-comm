...
import EasterSlider from "@/components/Sliders/EasternSlider";
...
const MenSection = () => {
    ...
    async function getSearch() {
      try {
        const response = await fetch(
          `http://localhost:1337/api/eastern-sections?populate[categories][populate][products][populate][image]=*`,
          {
            method: "GET",
            headers: {
  ...
  return (
    <div className="overflow-hidden">
      <div className="text-4xl  font-bold mt-36 flex justify-center">
        <h1>Eastern Wear Collection</h1>
      </div>
      <div className="mt-24">
        <EasterSlider />
      </div>
      ...
      <form onSubmit={handleSearch} className="w-[50%] mx-auto mt-12">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search Men's Eastern Wear"
            required
          />
        </div>
      </form>
