...
import FootwearSlider from "@/components/Sliders/FootwearSlider";
    ...
    async function getSearch() {
      try {
        const response = await fetch(
          `http://localhost:1337/api/footwear-sections?populate[categories][populate][products][populate][image]=*`,
          {
            method: "GET",
            headers: {
      ...
      <form onSubmit={handleSearch} className="w-[50%] mx-auto mt-12">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search Men's FootWear"
            required
          />
        </div>
      </form>
